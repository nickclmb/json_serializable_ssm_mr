...
Person _$PersonFromJson(Map<String, dynamic> json) => new Person(
    ...
    json[r'$house'] == null ? null : House.values.singleWhere((x) => x.toString() == "House.${json[r'$house']}"),
...
Order _$OrderFromJson(Map<String, dynamic> json) => new Order(
    ...
    (json['items'] as List)?.map((dynamic e) => e == null ? null : new Item.fromJson(e as Map<String, dynamic>)))
  ..count = json['count'] as int
  ..isRushed = json['isRushed'] as bool
  ..platform = json['platform'] == null ? null : new Platform.fromJson(json['platform'] as String)
  ..altPlatforms = json['altPlatforms'] == null
      ...
      : new Map<String, Platform>.fromIterables(
          ...
          (json['altPlatforms'] as Map)
              .values
              .map((dynamic e) => e == null ? null : new Platform.fromJson(e as String)));
...
Item _$ItemFromJson(Map<String, dynamic> json) => new Item(json['price'] as int)
  ...
  ..saleDates =
      (json['saleDates'] as List)?.map((dynamic e) => e == null ? null : DateTime.parse(e as String))?.toList()
...
abstract class _$ItemSerializerMixin {
  ...
  Map<String, dynamic> toJson() {
    ...
    val['saleDates'] = saleDates?.map((DateTime e) => e?.toIso8601String())?.toList();
    val['rates'] = rates;
    return val;
  }
}
